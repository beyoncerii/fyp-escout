...
@endauth
                            ...
                            @auth('staff')
                                @if (auth('staff')->user() && auth('staff')->user()->role == 'coach')
                                    <a class="d-flex justify-content-center mt-3 btn btn-success" href="https://api.whatsapp.com/send?phone=60{{ $athlete->phone }}&text=You're scouted!" style="margin-top: 10px;" onclick="return confirmScout();">Scout Athlete</a>
